...
public class MangaRepository {
    private static List<Manga> mangas = List.of(new Manga(1, "Boku no Hero", 50), new Manga(2, "Overload", 25));
    // Agora vamos criar 3 métodos
    // 1 para achar por title, 2 para achar por id
